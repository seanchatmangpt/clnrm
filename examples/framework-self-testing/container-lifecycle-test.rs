...
async fn main() -> Result<()> {
    ...
    println!("=================================================");
    println!("");
    println!("This example demonstrates the 'eat your own dog food' philosophy:");
    println!("The framework uses its own container lifecycle management to test");
    println!("that its container lifecycle management works correctly.");
    println!("");
    println!("Every claim made in the README about container lifecycle");
    println!("management is verified by actually using the framework's functionality.");
    println!("");
    println!("📋 What this proves:");
    println!("   ✅ Framework can create containers using its own container manager");
    println!("   ✅ Framework can execute commands in containers it manages");
    println!("   ✅ Framework's container reuse mechanism works correctly");
    println!("   ✅ Framework provides hermetic isolation between containers");
    println!("   ✅ Framework tracks container statistics accurately");
    println!("");
    println!("💡 Users can copy this code to verify the claims:");
    println!("   cargo run --example container-lifecycle-test");
    println!("");
    println!("🔬 This is framework self-testing in action!");
