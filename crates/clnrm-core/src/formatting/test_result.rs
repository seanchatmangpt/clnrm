...
mod tests {
    ...
    fn test_test_result_passed() {
        // Arrange & Act
        let result = TestResult::passed("test_name");
    ...
    fn test_test_result_failed() {
        // Arrange & Act
        let result = TestResult::failed("test_name", "error message");
    ...
    fn test_test_result_skipped() {
        // Arrange & Act
        let result = TestResult::skipped("test_name");
    ...
    fn test_test_result_with_duration() {
        // Arrange & Act
        let result = TestResult::passed("test_name").with_duration(Duration::from_millis(100));
    ...
    #[test]
    fn test_test_result_with_stdout() {
        // Arrange & Act
        let result = TestResult::passed("test_name").with_stdout("output");
    ...
    #[test]
    fn test_test_result_with_metadata() {
        // Arrange & Act
        let result = TestResult::passed("test_name").with_metadata("key", "value");
    ...
    fn test_test_suite_add_result() {
        ...
        // Act
        let suite = suite.add_result(TestResult::passed("test1"));
    ...
    #[test]
    fn test_test_suite_counts() {
        // Arrange
        let suite = TestSuite::new("suite_name")
            .add_result(TestResult::passed("test1"))
            .add_result(TestResult::passed("test2"))
            .add_result(TestResult::failed("test3", "error"))
            .add_result(TestResult::skipped("test4"));
    ...
    #[test]
    fn test_test_suite_is_success_with_all_passed() {
        // Arrange
        let suite = TestSuite::new("suite_name")
            .add_result(TestResult::passed("test1"))
            .add_result(TestResult::passed("test2"));
    ...
    #[test]
    fn test_test_suite_is_success_with_failures() {
        // Arrange
        let suite = TestSuite::new("suite_name")
            .add_result(TestResult::passed("test1"))
            .add_result(TestResult::failed("test2", "error"));
    ...
    #[test]
    fn test_test_suite_is_success_empty() {
        // Arrange
        let suite = TestSuite::new("suite_name");
