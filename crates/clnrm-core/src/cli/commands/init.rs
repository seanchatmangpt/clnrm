...
mod tests {
    ...
    fn test_init_project_default_name() -> Result<()> {
        ...
        let test_content = fs::read_to_string("tests/basic.clnrm.toml").map_err(|e| {
            CleanroomError::internal_error("Failed to read test file").with_source(e.to_string())
        })?;
        assert!(test_content.contains("name = \"basic_test\""));
        assert!(test_content.contains("[test.metadata]"));

        // Verify README content
        let readme_content = fs::read_to_string("README.md").map_err(|e| {
            CleanroomError::internal_error("Failed to read README file").with_source(e.to_string())
        })?;
    ...
    fn test_init_project_already_initialized() -> Result<()> {
        ...
        assert!(result
            .unwrap_err()
            .message
            .contains("Project already initialized"));
    ...
    fn test_init_project_creates_correct_directory_structure() -> Result<()> {
        ...
        let expected_dirs = vec!["tests", "scenarios"];
        ...
        let expected_files = vec!["README.md", "tests/basic.clnrm.toml"];
