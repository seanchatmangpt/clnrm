    ...
    pub fn new() -> Self {
        ...
        concepts.insert(
            ...
            ConceptDefinition {
                ...
                must_include_any: vec![
                    "KNHK".to_string(),
                    "Kinetic Knowledge Hypergraph".to_string(),
                ...
                boost_if_present: vec![
                    ...
                    "projection".to_string(),
                    "workflow as view".to_string(),
                    "ontology is law".to_string(),
                ],
                exclude: vec!["mock".to_string()],
                threshold: 0.65,
            },
        ...
        concepts.insert(
            ...
            ConceptDefinition {
                ...
                must_include_any: vec![
                    "DFLSS".to_string(),
                    "design for lean six sigma".to_string(),
                ],
                boost_if_present: vec![
                    "DMEDI".to_string(),
                    ...
                    "ML loop".to_string(),
                    "agent-driven".to_string(),
                ],
                exclude: vec!["DFSS".to_string()], // Important: DFLSS, not DFSS
                threshold: 0.7,
            },
        );
